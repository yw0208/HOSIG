...
class CMDM(torch.nn.Module):
    def __init__(self, modeltype, njoints, nfeats, num_actions, translation, pose_rep, glob, glob_rot,
        ...
        n_joints = 22
        self.input_hint_block = HintBlock(self.data_rep, n_joints * 3 + 96, self.latent_dim)
    ...
    def encode_text(self, raw_text):
        ...
        max_text_len = 20 if self.dataset in ['humanml', 'trumans','kit'] else None  # Specific hardcoding for humanml dataset
