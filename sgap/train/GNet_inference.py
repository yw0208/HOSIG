...
class Trainer:
    ...
    def inference_generate(self):
        ...
        for batch_id, batch in enumerate(data):
            ...
            if 'trumans' in self.cfg.datasets.dataset_dir.lower():
                obj_name = self.data_info[ds_name]['frame_names'][batch['idx'].to(torch.long)].split('/')[-1]
            else:
            ...
            movie_path = os.path.join(base_movie_path, f'{movie_name}_{str(mov_count)}'+'.html')
...
def inference():
    ...
    parser.add_argument('--grab-path',
                        default='/opt/data/private/datasets/trumans4gnet',
                        type=str,
                        help='The path to the folder that contains GRAB data')

    parser.add_argument('--smplx-path',
                        default='smplx/models',
                        type=str,
                        help='The path to the folder containing SMPL-X model downloaded from the website')

    parser.add_argument('--expr-id', default='GNet_V05', type=str,
                        help='Training ID')

    # parser.add_argument('--load_model', default='saves/GNet_V00/snapshots/E132_model.pt', type=str,)
    # parser.add_argument('--load_model', default='saves/GNet_V01/snapshots/E133_model.pt', type=str,)
    parser.add_argument('--load_model', default='saves/GNet_V02/snapshots/E113_model.pt', type=str,)
    # parser.add_argument('--load_model', default='saves/GNet_V03/snapshots/E217_model.pt', type=str,)
    # parser.add_argument('--load_model', default='saves/GNet_V04/snapshots/E280_model.pt', type=str,)
    # parser.add_argument('--load_model', default='saves/GNet_V05/snapshots/E118_model.pt', type=str,)
    ...
    cfg.results_base_dir = os.path.join(cfg.output_folder, cfg.expr_ID, f'results_{os.path.basename(cfg.best_model).split("_")[0]}')
