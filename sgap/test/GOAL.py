...
from toolss.vis_tools import sp_animation, get_ground
...
class Trainer:
    ...
    def inference_generate(self):
        ...
        for batch_id, batch in enumerate(data):
            ...
            from toolss.gnet_optim import GNetOptim as FitSmplxStatic
            ...
            from toolss.mnet_optim import MNetOpt as FitSmplxMotion
