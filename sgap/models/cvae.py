...
from toolss.utils import rotmat2aa
from toolss.utils import d62rotmat
from toolss.utils import batch_to
from toolss.train_tools import point2point_signed
...
class gnet_model(nn.Module):
    ...
    def encode(self, enc_x):
        # enc_x: fullpose_rotmat, transl, betas, transl_obj, verts2obj, verts, bps_obj, scene
    ...
    def decode(self, dec_x):
        # dec_x: betas, transl_obj, bps_obj, z, scene
        ...
        return {'pose':pose, 'trans':trans, 'dist':dist, 'gaze':gaze} # dist: rh2obj; gaze: head direction
