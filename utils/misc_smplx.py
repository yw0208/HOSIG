...
smplx_male_model_45 = sk.SMPLXLayer(model_path='body_models/smplx/models', gender='male', num_betas=10, num_pca_comps=45)
smplx_neutral_model = sk.SMPLXLayer(model_path='body_models/smplx/models', gender='neutral', num_betas=10, num_pca_comps=-1)
