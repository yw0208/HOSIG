...
def add_training_options(parser):
    ...
    group.add_argument("--save_dir", default='save/scomogen', type=str,
    ...
    group.add_argument("--log_interval", default=2_00, type=int,
...
def add_sampling_options(parser):
    ...
    group.add_argument("--model_path", default="save/scomogen/model000875000.pt", type=str,
...
def add_generate_options(parser):
    ...
    group.add_argument("--scene_guidance", default=True, type=bool,
                       help="if use scene guidance")
